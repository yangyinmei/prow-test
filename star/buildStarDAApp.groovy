...
def sourceCodeGitUrl = "10.0.250.70:8088/star_web/starDA-app.git"
    ...
    if(buildStatus.contentEquals("unset")) {
        try {
            stage('upload building product to ftp') {
                sh"""
                    mv ${sourceCodeDir}/app/build/outputs/apk/app-release.apk ${sourceCodeDir}/app/build/outputs/apk/StarDA-${tag}.apk
