...
def sourceCodeGitUrl = "10.0.250.70:8088/starapp/starapp-android.git"
...
node('base3-slave') {
    ...
    //             dir(sourceCodeDir) {
    //                 sh"""
    //                     echo "BUILDER  : $BUILDER" > ./startvhelper/build/outputs/apk/buildinfo.txt
    //                 """
    //                 if(ifTag.contentEquals("Y")) {
    //                     sh"""
    //                         echo "TAG      : $tag" >> ./startvhelper/build/outputs/apk/buildinfo.txt
    //                     """
    //                 }
    //             }
                ...
                dir(sourceCodeDir) {
                    sh"""
                        if [ ! -d  sonar-project.properties ]; then
                            ...
                            echo "sonar.java.binaries=./startvhelper,./startvhelper_common" >> ./sonar-project.properties
                        fi
                        source /etc/profile
                        sonar-scanner
                    """
